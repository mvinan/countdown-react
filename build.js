...
var _reactSimpleCountdown = require('react-simple-countdown');

var _reactSimpleCountdown2 = _interopRequireDefault(_reactSimpleCountdown);

var MyComponent = _react2['default'].createClass({
  displayName: 'MyComponent',

  render: function render() {
    return _react2['default'].createElement(_reactSimpleCountdown2['default'], { date: '2015-09-12T00:00:00+00:00', className: 'CountDown' });
  }
});
_react2['default'].render(_react2['default'].createElement(MyComponent, null), document.body);

},{"react":157,"react-simple-countdown":2}],2:[function(require,module,exports){
'use strict';
